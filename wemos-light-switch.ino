...
void switchOutput(int a, int value) {
  switch (value) {
    ...
    case 1:
      switch (a) {
        case 1: digitalWrite(D3, value); server.send (200, "text/html", "OK <a href='/1/on'>sw ON</a> <a href='/1/off'>sw OFF</a>"); break;
        case 2: digitalWrite(D4, value); server.send (200, "text/html", "OK <a href='/2/on'>sw ON</a> <a href='/2/off'>sw OFF</a>"); break;
      }
      break;
    case 2:
      switch (a) {
